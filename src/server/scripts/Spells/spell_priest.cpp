    ...
    public:
        ...
        class spell_pri_holy_nova_SpellScript : public SpellScript
        {
			...
			void HandleOnCast()
			{
				...
				if (l_Caster->HasAura(152117)) // Words of mending aura
				{
					if (!l_Caster->HasAura(155363)) // Words of mending proc
						l_Caster->CastSpell(l_Caster, 155362, true); // Words of mending stack
				}
			}
            ...
            void Register()
            {
				...
				OnCast += SpellCastFn(spell_pri_holy_nova_SpellScript::HandleOnCast);
            }
        };
...
public:
	...
	class spell_pri_power_word_shield_SpellScript : public SpellScript
	{
		...
		{
			OnCast += SpellCastFn(spell_pri_power_word_shield_SpellScript::HandleOnCast);
		}
	};
    ...
    public:
        ...
        class spell_pri_halo_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
				...
				OnCast += SpellCastFn(spell_pri_halo_SpellScript::HandleOnCast);
            }
        };
...
/// Prayer of Mending - 33076, Prayer of Mending - 123259
    ...
    public:
        ...
        class spell_pri_prayer_of_mending_SpellScript : public SpellScript
        {
            ...
            void HandleOnHit()
            {
                if (Unit* l_Caster = GetCaster())
                {
                    if (Unit* l_Target = GetHitUnit())
                    {
                        ...
                        {
                            if (l_Target->HasAura(eSpells::PrayerOfMendingDivineI))
                                l_Stacks = l_Target->GetAura(eSpells::PrayerOfMendingDivineI)->GetStackAmount();
                            else
                                l_Caster->CastSpell(l_Target, eSpells::PrayerOfMendingDivineI, true);
                        }
                        ...
                        if (GetSpellInfo()->Id == eSpells::PrayerOfMending)
                            ...
                            l_PrayerOfMendingAura = l_Target->GetAura(eSpells::PrayerOfMendingDivineI, l_Caster->GetGUID());
						...
						if (l_PrayerOfMendingAura != nullptr)
						{
							...
							l_PrayerOfMendingAura->RefreshDuration(l_Stacks);
						}
            ...
            void Register() override
            {
				...
				OnCast += SpellCastFn(spell_pri_prayer_of_mending_SpellScript::HandleOnCast);
            }
        };
...
/// Prayer of mending aura - 41635, Prayer of mending aura - 123262 
    ...
    public:
        ...
        class spell_pri_prayer_of_mending_aura_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                ...
                {
                case eSpells::PrayerOfMenfinInsight:
                    AfterEffectApply += AuraEffectApplyFn(spell_pri_prayer_of_mending_aura_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
                    break;
            ...
            void HandleHeal(SpellEffIndex /*p_EffIndex*/)
            {
                if (Unit* l_Caster = GetOriginalCaster())
                {
                    if (Unit* l_Target = GetHitUnit())
                    {
                        ...
                        if (l_AurEff == nullptr)
                            l_AurEff = l_Target->GetAuraEffect(123262, EFFECT_0, l_Caster->GetGUID());
    ...
    public:
        ...
        void OnSpellCast(Player* p_Player, Spell* p_Spell, bool skipCheck)
        {
            ...
            if (p_Player->HasAura(eSpells::WordOfMendingAura) && p_Spell->GetSpellInfo() && (p_Spell->GetSpellInfo()->IsHealingSpell() ||
                ...
                p_Spell->GetSpellInfo()->IsShieldingSpell()) && p_Spell->GetSpellInfo()->Id != 146347) // Life steal should not count towards it
            {
...
class spell_pri_divine_star : public SpellScriptLoader
{
	public:
		...
		class spell_pri_divine_star_SpellScript : public SpellScript
		{
			...
			void Register() override
			{
				OnCast += SpellCastFn(spell_pri_divine_star_SpellScript::HandleOnCast);
			}
		};
