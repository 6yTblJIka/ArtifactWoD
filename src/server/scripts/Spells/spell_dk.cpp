...
class spell_dk_necrotic_plague_visual : public SpellScriptLoader
{
public:
	spell_dk_necrotic_plague_visual() : SpellScriptLoader("spell_dk_necrotic_plague_visual") { }

	class spell_dk_necrotic_plague_visual_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_dk_necrotic_plague_visual_SpellScript);
		...
		void HandleOnHit()
		{
			...
			if (!l_Caster->IsWithinDistInMap(l_Target, 5.0f))
				l_Caster->CastSpell(l_Target, NecroticPlagueVisual, true);
		}

		void Register()
		{
			OnHit += SpellHitFn(spell_dk_necrotic_plague_visual_SpellScript::HandleOnHit);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_dk_necrotic_plague_visual_SpellScript();
	}
};
...
void AddSC_deathknight_spell_scripts()
{
	...
	new spell_dk_necrotic_plague_visual();
