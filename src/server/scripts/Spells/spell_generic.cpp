...
namespace Resolve
{
    ...
    {
		0.5, 1, 2, 3, 4, 4.5, 5, 6, 6.5, 7,												   ///< 01-10
        7, 7.5, 8, 8.5, 10, 12, 13, 13.5, 14, 17,										   ///< 11-20
		19, 25, 30, 33, 34, 36, 37.5, 38, 39, 45,										   ///< 21-30
		52, 53, 55, 60, 65, 66, 67, 68, 69, 80,											   ///< 31-40
		82, 84, 88, 90, 92, 96, 98, 100, 115, 120,										   ///< 41-50
		125, 130, 135, 140, 145, 148, 150, 152, 490, 155,								   ///< 51-60
		160, 180, 184, 188, 190, 202, 209, 219, 220, 227,								   ///< 61-70
		245, 254, 264, 276, 282, 290, 306, 324, 336, 338,								   ///< 71-80
        378, 410, 430, 469, 501, 570, 640, 730, 820, 847.125,							   ///< 81-90
    ...
    class PlayerScript_Resolve : public PlayerScript
    {
        ...
        private:
            ...
            /// Check if the current player is avaliable to resolve aura
