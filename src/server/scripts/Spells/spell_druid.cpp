...
enum LifebloomSpells
{
	...
	SPELL_DRUID_LIFEBLOOM_T18 = 188550,
...
/// Lifebloom - 33763 & Lifebloom (T18) - 188550 : Refresh duration
    ...
    public:
        ...
        class spell_dru_lifebloom_refresh_SpellScript : public SpellScript
        {
            ...
            void HandleOnHit()
            {
                ...
                {
					if (Aura* l_Lifebloom = l_Target->GetAura(SPELL_DRUID_LIFEBLOOM_T18, l_Caster->GetGUID()))
						l_Lifebloom->RefreshDuration();

                    else if (Aura* l_Lifebloom = l_Target->GetAura(SPELL_DRUID_LIFEBLOOM, l_Caster->GetGUID()))
                        l_Lifebloom->RefreshDuration();
                }
            }
...
/// Lifebloom (T18) - 188550
class spell_dru_lifebloom_T18 : public SpellScriptLoader
{
public:
	spell_dru_lifebloom_T18() : SpellScriptLoader("spell_dru_lifebloom_T18") { }

	class spell_dru_lifebloom_T18_AuraScript : public AuraScript
	{
		PrepareAuraScript(spell_dru_lifebloom_T18_AuraScript);
		...
		void Register()
		{
			AfterEffectRemove += AuraEffectRemoveFn(spell_dru_lifebloom_T18_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_PERIODIC_HEAL, AURA_EFFECT_HANDLE_REAL);
			OnDispel += AuraDispelFn(spell_dru_lifebloom_T18_AuraScript::HandleDispel);
			OnEffectPeriodic += AuraEffectPeriodicFn(spell_dru_lifebloom_T18_AuraScript::OnTick, EFFECT_0, SPELL_AURA_PERIODIC_HEAL);
		}
	};

	AuraScript* GetAuraScript() const
	{
		return new spell_dru_lifebloom_T18_AuraScript();
	}
};
    ...
    public:
        ...
        class spell_dru_moonfire_SpellScript : public SpellScript
        {
			...
			void HandleOnCast()
			{
				...
				if (l_Caster->HasAura(eSpells::T18_Balance_2P))
				{
					if (roll_chance_i)
					{
						l_Caster->CastSpell(l_Caster, eSpells::FeyMoonwing, true);
					}
				}
			}
            ...
            void Register()
            {
				...
				OnCast += SpellCastFn(spell_dru_moonfire_SpellScript::HandleOnCast);
...
/// Fey Missile - 188046
class spell_dru_fey_missile : public SpellScriptLoader
{
public:
	spell_dru_fey_missile() : SpellScriptLoader("spell_dru_fey_missile") { }

	class spell_dru_fey_missile_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_dru_fey_missile_SpellScript);
		...
		void Register()
		{
			OnEffectHitTarget += SpellEffectFn(spell_dru_fey_missile_SpellScript::HandleDamage, EFFECT_0, SPELL_EFFECT_SCHOOL_DAMAGE);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_dru_fey_missile_SpellScript();
	}
};
    ...
    public:
        ...
        class spell_dru_sunfire_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
				...
				OnCast += SpellCastFn(spell_dru_sunfire_SpellScript::HandleOnCast);
...
class spell_dru_moonfire_sunfire_damage : public SpellScriptLoader
{
    public:
		...
		class spell_dru_moonfire_sunfire_damage_AuraScript : public AuraScript
		{
			...
			void Register()
			{
				OnEffectPeriodic += AuraEffectPeriodicFn(spell_dru_moonfire_sunfire_damage_AuraScript::HandleOnTick, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE);
			}
		};
    ...
    public:
        ...
        class spell_dru_starsurge_SpellScript : public SpellScript
        {
            ...
            enum eSpells
            {
				...
				SeedofCreationBalance = 184876, //Starshards
				Starfall = 100804,
				Sunfall = 155002
			...
			void HandleOnCast()
			{
				...
				if (l_Caster->HasAura(184876)) // Seed of Creation (Starshards, balance)
				{
					if (roll_chance_i(l_SpellInfo->Effects[EFFECT_0].BasePoints))
					{
						if (l_Caster->HasAura(171803)) // Glyph of the Solstice
							l_Caster->AddAura(185002, l_Caster); // Sunfall
						else
							l_Caster->AddAura(100804, l_Caster); // Starfall
					}
				}
			}
