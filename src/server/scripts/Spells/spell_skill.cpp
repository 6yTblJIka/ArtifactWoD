    ...
    public:
        ...
        class spell_skill_upgrade_armor_or_weapon_SpellScript : public SpellScript
        {
            ...
            enum eSpells
            {
				...
				BlackSmithingWeaponFourth	= 187500,
				BlackSmithingWeaponFifth	= 187523,

                EngineeringWeaponMeta       = 187552,
                EngineeringWeaponFirst      = 177361,
                EngineeringWeaponSecond     = 177362,
                EngineeringWeaponThird      = 181413,
				EngineeringWeaponFourth		= 187506,
				EngineeringWeaponFifth		= 187529,

                InscriptionWeaponMeta       = 187535,
                InscriptionWeaponFirst      = 165808,
                InscritpionWeaponSecond     = 178250,
                InscriptionWeaponThird      = 181411,
				InscriptionWeaponFourth		= 187504,
				InscriptionWeaponFifth		= 187527
            };

            std::map<uint32, std::vector<uint32>> m_UpgradeSpells =
            {
				{ eSpells::BlacksmithingArmorMeta   ,{ eSpells::BlacksmithingArmorFirst , eSpells::BlacksmithingArmorSecond , eSpells::BlacksmithingArmorThird  , eSpells::BlacksmithingArmorFourth , eSpells::BlacksmithingArmorFifth  }},
				{ eSpells::InscriptionArmorMeta     ,{ eSpells::InscriptionArmorFirst   , eSpells::InscritpionArmorSecond   , eSpells::InscriptionArmorThird    , eSpells::InscriptionArmorFourth   , eSpells::InscriptionArmorFifth    }},
                { eSpells::LeatherworkingArmorMeta  ,{ eSpells::LeatherworkingArmorFirst, eSpells::LeatherworkingArmorSecond, eSpells::LeatherworkingArmorThird , eSpells::LeatherworkingArmorFourth, eSpells::LeatherworkingArmorFifth }},
				{ eSpells::TailoringArmorMeta       ,{ eSpells::TailoringArmorFirst     , eSpells::TailoringArmorSecond     , eSpells::TailoringArmorThird      , eSpells::TailoringArmorFourth     , eSpells::TailoringArmorFifth      }},
                { eSpells::EngineeringArmorMeta     ,{ eSpells::EngineeringArmorFirst   , eSpells::EngineeringArmorSecond   , eSpells::EngineeringArmorThird    , eSpells::EngineeringArmorFourth   , eSpells::EngineeringArmorFifth    }},
				{ eSpells::JewelcraftingArmorMeta   ,{ eSpells::JewelcraftingArmorFirst , eSpells::JewelcraftingArmorSecond , eSpells::JewelcraftingArmorThird  , eSpells::JewelcraftingArmorFourth , eSpells::JewelcraftingArmorFifth  }},
                { eSpells::BlacksmithingWeaponMeta  ,{ eSpells::BlacksmithingWeaponFirst, eSpells::BlacksmithingWeaponSecond, eSpells::BlackSmithingWeaponThird , eSpells::BlackSmithingWeaponFourth, eSpells::BlackSmithingWeaponFifth }},
				{ eSpells::EngineeringWeaponMeta    ,{ eSpells::EngineeringWeaponFirst  , eSpells::EngineeringWeaponSecond  , eSpells::EngineeringWeaponThird   , eSpells::EngineeringWeaponFourth  , eSpells::EngineeringWeaponFifth   }},
                { eSpells::InscriptionWeaponMeta    ,{ eSpells::InscriptionWeaponFirst  , eSpells::InscritpionWeaponSecond  , eSpells::InscriptionWeaponThird   , eSpells::InscriptionWeaponFourth  , eSpells::InscriptionWeaponFifth   }}
            };
            ...
            void HandleChangeBonuses(SpellEffIndex p_EffIndex)
            {
                ...
                if (Item* l_ItemTarget = GetExplTargetItem())
                {
                    if (Player* l_Player = GetCaster()->ToPlayer())
                    {
                        ...
                        if (!l_SpellInfo || !m_UpgradeSpells[l_SpellInfo->Id].size() != 5)
                            return;

						if (l_ItemLevel >= 700)
							l_Triggered = m_UpgradeSpells[l_SpellInfo->Id][4];
						else if (l_ItemLevel >= 685)
							l_Triggered = m_UpgradeSpells[l_SpellInfo->Id][3];
                        else if (l_ItemLevel >= 670)
