...
namespace MS { namespace Garrison { namespace Sites
{
    ...
    /// Garrison horde site level 2 instance script
    class InstanceScript_GarrisonHordeLevel2 : public GarrisonSiteBase
    {
        public:
            /// Constructor
            /// @p_Map : Target map
            InstanceScript_GarrisonHordeLevel2(Map* p_Map);
            /// Destructor
            ~InstanceScript_GarrisonHordeLevel2();
