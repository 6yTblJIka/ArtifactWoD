...
namespace MS { namespace Garrison { namespace Sites
{
    ...
    class InstanceScript_GarrisonAllianceLevel3 : public GarrisonSiteBase
    {
        public:
            /// Constructor
            /// @p_Map : Target map
            InstanceScript_GarrisonAllianceLevel3(Map* p_Map);
            /// Destructor
            ~InstanceScript_GarrisonAllianceLevel3();
