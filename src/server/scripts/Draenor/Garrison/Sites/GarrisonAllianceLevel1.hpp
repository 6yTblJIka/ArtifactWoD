...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef GARRISON_ALLIANCE_LEVEL_1_HPP_GARRISON
#ifndef CROSS
#define GARRISON_ALLIANCE_LEVEL_1_HPP_GARRISON
...
{
    /// Garrison alliance site level 1 instance map script
    class InstanceMapScript_GarrisonAllianceLevel1 : public InstanceMapScript
    {
        public:
            /// Constructor
            InstanceMapScript_GarrisonAllianceLevel1();
    ...
    /// Garrison alliance site level 1 instance script
    class InstanceScript_GarrisonAllianceLevel1 : public GarrisonSiteBase
    {
        public:
            /// Constructor
            /// @p_Map : Target map
            InstanceScript_GarrisonAllianceLevel1(Map* p_Map);
            /// Destructor
            ~InstanceScript_GarrisonAllianceLevel1();
...
#endif  ///< GARRISON_ALLIANCE_LEVEL_1_HPP_GARRISON
#endif
