...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef GARRISON_ALLIANCE_SHIPYARD_HPP
#ifndef CROSS
#define GARRISON_ALLIANCE_SHIPYARD_HPP
...
namespace MS { namespace Garrison { namespace Sites
{
    ...
    class InstanceMapScript_GarrisonAllianceShipyard : public InstanceMapScript
    {
        public:
            /// Constructor
            InstanceMapScript_GarrisonAllianceShipyard();
    ...
    class InstanceScript_GarrisonAllianceShipyard : public GarrisonSiteBase
    {
        public:
            /// Constructor
            /// @p_Map : Target map
            InstanceScript_GarrisonAllianceShipyard(Map* p_Map);
            /// Destructor
            ~InstanceScript_GarrisonAllianceShipyard();
...
#endif  ///< GARRISON_ALLIANCE_SHIPYARD_HPP
#endif
