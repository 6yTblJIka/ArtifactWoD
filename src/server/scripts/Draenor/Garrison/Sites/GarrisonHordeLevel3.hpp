...
namespace MS { namespace Garrison { namespace Sites
{
    ...
    /// Garrison horde site level 3 instance script
    class InstanceScript_GarrisonHordeLevel3 : public GarrisonSiteBase
    {
        public:
            /// Constructor
            /// @p_Map : Target map
            InstanceScript_GarrisonHordeLevel3(Map* p_Map);
            /// Destructor
            ~InstanceScript_GarrisonHordeLevel3();
