	...
	namespace Garrison
	{
		...
		namespace Quests
		{
			enum
			{
				...
				Alliance_DelegatingOnDraenor = 34692,
				Alliance_AHerosWelcome = 33075,
		...
		{
			// Alliance
			NpcBarosAlexstone = 77209,
			NpcAssistantBrightstone = 84455,
			...
			NpcGarrisonAllianceCart = 81627,
			NpcGarrisonAllianceHorse = 81633,
			NpcLunarfallRaccoon = 85341,
		...
		namespace GarrisonPortals
		{
			static std::vector<std::vector<std::vector<Position>>> const g_GobPos =
			{
				...
				/// Horde
				{
					/// Level 1
					{
						...
						{ 8.36360f, 5.51080f, 1.8847f, 3.7451f },
					},
					...
					/// Level 2
					{
						...
						{ 5.36360f, 8.51080f, 1.8847f, 7.7451f },
					},
					...
					/// Level 3
					{
						...
						{ 10.2846f, -7.28290f, 28.5693f, 3.3263f },
					},
				},
			};
			...
			enum DeactivationSpells
			{
				...
				TanaanDeactivationSpell = 190372
			};
		...
		enum CreatureTexts
		{
			...
			CREATURE_TEXT_VINDICATOR_MARAAD_BARRACKS_END_CHAT = 3,
			CREATURE_TEXT_VINDICATOR_MARAAD_QIANA_START_CHAT = 4,
		...
		static const float gGarrisonHearthStoneTeleportCoord[][4] =
		{
			...
			{ 1947.08f,   324.883f,  90.28076f, 0.00f    }  ///< Alliance Level 3
		};
