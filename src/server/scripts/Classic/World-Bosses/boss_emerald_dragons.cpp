	...
	struct boss_ysondreAI : public emerald_dragonAI
	{
		...
		void ExecuteEvent(uint32 eventId) override
		{
			...
			case EVENT_LIGHTNING_WAVE:
				...
				events.ScheduleEvent(EVENT_LIGHTNING_WAVE, 10000, 20000);
				break;
			default:
	...
	struct boss_lethonAI : public emerald_dragonAI
	{
		...
		void ExecuteEvent(uint32 eventId)
		{
			...
			case EVENT_SHADOW_BOLT_WHIRL:
				...
				events.ScheduleEvent(EVENT_SHADOW_BOLT_WHIRL, 15000, 30000);
				break;
			default:
				emerald_dragonAI::ExecuteEvent(eventId);
				break;
	...
	struct boss_taerarAI : public emerald_dragonAI
	{
		...
		void ExecuteEvent(uint32 eventId) override
		{
			...
			case EVENT_ARCANE_BLAST:
				...
				events.ScheduleEvent(EVENT_ARCANE_BLAST, 7000, 12000);
				break;
			case EVENT_BELLOWING_ROAR:
				DoCast(SPELL_BELLOWING_ROAR);
				events.ScheduleEvent(EVENT_BELLOWING_ROAR, 20000, 30000);
				break;
			default:
				emerald_dragonAI::ExecuteEvent(eventId);
				break;
