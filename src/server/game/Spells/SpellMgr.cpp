...
void SpellMgr::LoadPetLevelupSpellMap()
{
    ...
    /// Hackfix for void Shield
    mPetLevelupSpellMap[CREATURE_FAMILY_VOIDLORD].insert({ 28, 115236 });
    ++count;
...
void SpellMgr::LoadSpellCustomAttr()
{
    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
		   ...
		   /// Tanaan Intro spells
		   ///////////////////////////////////////////////////////////////////////////////////
			case 167422: //< Shadowstep
				spellInfo->Effects[EFFECT_0].TargetA = TARGET_DEST_TARGET_RANDOM;
				break;
			case 165511: //< Uplift
				spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_TARGET_ALLY;
				break;
			case 165520: //< Volley
				spellInfo->Effects[EFFECT_0].TriggerSpell = 165523;
				break;
			case 163313: // Starfall triggered
				spellInfo->Effects[EFFECT_0].SetRadiusIndex(18); ///< 15 yards
				break;
			case 163799: //< Looming Army
				spellInfo->AreaGroupId = 0;
				spellInfo->Effects[EFFECT_0].Effect = SPELL_EFFECT_PLAY_SCENE;
				spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_CASTER;
				spellInfo->Effects[EFFECT_0].MiscValue = 923; ///< Scene ID
				break;
			case 163341: //< Soul train
				spellInfo->Effects[EFFECT_0].MiscValue = 1018; ///< Scene ID
				break;
			case 164530: //< Power Spire N
				spellInfo->Effects[EFFECT_0].MiscValue = 959; ///< Scene ID
				break;
			case 166402: //< Power Spire S
				spellInfo->Effects[EFFECT_0].MiscValue = 960; ///< Scene ID
				break;
			case 164678: //< Dwarves event
				spellInfo->Effects[EFFECT_0].MiscValue = 937; ///< Scene ID
				break;
			case 163806: //< Khadgar sets off bombs
				spellInfo->Effects[EFFECT_0].MiscValue = 924; ///< Scene ID
				break;
			case 158985: //< Run away
				spellInfo->Effects[EFFECT_0].MiscValue = 806; ///< Scene ID
				break;
			case 158984: //< Run through
				spellInfo->Effects[EFFECT_0].MiscValue = 942; ///< Scene ID
				break;
			case 159509: //< Grommash runs to boats
				spellInfo->Effects[EFFECT_0].MiscValue = 836; ///< Scene ID
				break;
			case 159508: //< Blackrock run to tank
				spellInfo->Effects[EFFECT_0].MiscValue = 835; ///< Scene ID
				break;
			case 159507: //< Blackrock run to quarry
				spellInfo->Effects[EFFECT_0].MiscValue = 834; ///< Scene ID
				break;
			case 159506: //< Shattered hand run to cave
				spellInfo->Effects[EFFECT_0].MiscValue = 833; ///< Scene ID
				break;
		   ///////////////////////////////////////////////////////////////////////////////////
		   /// Shadowmoon Valley spells
		   ///////////////////////////////////////////////////////////////////////////////////
			case 160325: //< Poison Claws
				spellInfo->StackAmount = 3;
				break;
		   ///////////////////////////////////////////////////////////////////////////////////
		   /// Zangarra spells
		   ///////////////////////////////////////////////////////////////////////////////////
			case 170520: //< Frost Channeling
				spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_TARGET_ANY;
				break;
			case 170509: //< Fire Channeling
				spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_TARGET_ANY;
				break;
		   ///////////////////////////////////////////////////////////////////////////////////
		   /// Hellfire Citadel spells
		   ///////////////////////////////////////////////////////////////////////////////////
			case 182259: //< Beam Spire
				spellInfo->Effects[EFFECT_0].TargetB = TARGET_UNIT_SRC_AREA_ENTRY;
				spellInfo->MaxAffectedTargets = 1;
				break;
			case 185256: //< Spire Channel (triggered from 185257)
				spellInfo->Effects[EFFECT_0].TargetB = TARGET_UNIT_SRC_AREA_ENTRY;
				spellInfo->MaxAffectedTargets = 1;
				break;
			case 187029: //< Portal Channel (triggered from 187028)
				spellInfo->Effects[EFFECT_0].TargetB = TARGET_UNIT_SRC_AREA_ENTRY;
				spellInfo->MaxAffectedTargets = 1;
				break;
			case 189304: // Arcane Blast 
				spellInfo->Effects[EFFECT_0].TargetB = TARGET_UNIT_SRC_AREA_ENTRY;
				spellInfo->MaxAffectedTargets = 1;
				break;
			case 189358: //< Arcane Barrage
				spellInfo->Effects[EFFECT_0].TargetB = TARGET_UNIT_SRC_AREA_ENTRY;
				spellInfo->MaxAffectedTargets = 1;
				break;
			case 189362: //< Arcane Missiles (triggered from 189361)
				spellInfo->Effects[EFFECT_0].TargetB = TARGET_UNIT_SRC_AREA_ENTRY;
				spellInfo->MaxAffectedTargets = 1;
				break;
			case 189301: //< Mortal Strike
				spellInfo->Effects[EFFECT_0].TargetB = TARGET_UNIT_SRC_AREA_ENTRY;
				spellInfo->MaxAffectedTargets = 1;
				break;
			case 189290: // Holy Shock
				spellInfo->Effects[EFFECT_0].TargetB = TARGET_UNIT_SRC_AREA_ENTRY;
				spellInfo->MaxAffectedTargets = 1;
				break;
			case 189289: // Flash of Light
				spellInfo->Effects[EFFECT_0].TargetB = TARGET_UNIT_SRC_AREA_ENTRY;
				spellInfo->MaxAffectedTargets = 1;
				break;
			///////////////////////////////////////////////////////////////////////////////////
            ...
            case 108977: //< Way of the Monk
                ...
                break;
			///////////////////////////////////////////////////////////////////////////////////
			/// Frostwolf Shamanstone buffs (Frostfire Ridge)
			///////////////////////////////////////////////////////////////////////////////////
			case 155347: ///< Spirit of the Wolf
			case 154253: ///< Blessing of the Wolf
			case 155344: ///< Buffeting Galefury
			case 155346: ///< Ogrish Fortitude
			case 155315: ///< Touched by Fire
			case 155334: ///< Touched by Ice
				spellInfo->AreaGroupId = 0; ///< handle zone restriction manually in SpellInfo::CheckLocation
				break;
            ///////////////////////////////////////////////////////////////////////////////////
            /// Mine Spells
            ///////////////////////////////////////////////////////////////////////////////////
            case 176061: ///< Preserved Mining Pick
            case 176049: ///< Miner's Coffee
                spellInfo->AreaGroupId = 0; ///< handle zone restriction manually in SpellInfo::CheckLocation
                break;
            ///////////////////////////////////////////////////////////////////////////////////
            /// Rush Orders
            ...
            case 105157: ///< See Quest Invis 14, Wandering Island spell
                spellInfo->AreaGroupId = 0;
                break;
			case 59544: ///< Gift of the Naaru (Priest)
			case 59542: ///< Gift of the Naaru (Paladin)
			case 28880: ///< Gift of the Naaru (Warrior)
			case 59543: ///< Gift of the Naaru (Hunter)
			case 59547: ///< Gift of the Naaru (Shaman)
			case 59548: ///< Gift of the Naaru (Mage)
			case 121093: ///< Gift of the Naaru (Monk)
            ...
            case 156053: ///< Slag Bomb (Slag Bomb - Blackhand)
                spellInfo->Effects[EFFECT_0].ApplyAuraName = SPELL_AURA_DUMMY;
                break;
            case 156653: ///< Fixate (Siegemaker - Blackhand)
                spellInfo->Effects[EFFECT_0].ApplyAuraName = SPELL_AURA_DUMMY;
                spellInfo->AttributesCu |= SPELL_ATTR0_CU_NEGATIVE;
                break;
            ...
            case 163153: ///< Enchant Armament (Jump - Enchanted Armament)
                ...
                break;
            case 155074: ///< Charring Breath (Cinder Wolf - Flamebender Ka'graz)
            ...
            case 155992: ///< Shattering Smash (Blackhand)
            case 158054: ///< Massive Shattering Smash (Blackhand)
            ...
            case 161347: ///< Jump To Second Floor (Blackhand)
            case 161348: ///< Jump To Third Floor (Blackhand)
                spellInfo->Effects[EFFECT_0].TargetA = TARGET_DEST_DEST;
                spellInfo->Effects[EFFECT_0].TargetB = 0;
                break;
            ...
            case 158681: ///< Corrupted Blood - Missile (Uk'urogg - Iron Maidens)
                ...
                spellInfo->Effects[EFFECT_0].TargetB = 0;
                break;
            case 175576: ///< Flame Jet - AoE select (Forgemistress Flamehand)
            case 177554: ///< Flame Jet - AoE deselect (Forgemistress Flamehand)
                spellInfo->AttributesEx6 |= SPELL_ATTR6_CAN_TARGET_UNTARGETABLE;
                break;
            case 156496: ///< Demolition - Small AoE (Blackrock Foundry - Blackhand)
                spellInfo->Effects[EFFECT_0].TargetA = TARGET_DEST_CASTER;
                spellInfo->AttributesEx3 &= ~SPELL_ATTR3_ONLY_TARGET_PLAYERS;
                break;
            case 156503: ///< Massive Demolition - Big AoE (Blackrock Foundry - Blackhand)
                spellInfo->Effects[EFFECT_0].TargetA = TARGET_DEST_CASTER;
                spellInfo->Effects[EFFECT_1].TargetA = TARGET_DEST_CASTER;
                spellInfo->AttributesEx3 &= ~SPELL_ATTR3_ONLY_TARGET_PLAYERS;
                break;
            case 156096: ///< Marked for Death (Blackhand)
            ...
            case 182078: ///< Chi Explosion
                ...
                break;
			case 164061: ///< Death From Above - First Leap
				spellInfo->CastTimeEntry = 0;
				break;
            ...
            case 178236:///< Death from Above (jump dest)
                spellInfo->Effects[0].TargetB = TARGET_DEST_TARGET_ANY;
                spellInfo->Effects[0].ValueMultiplier = 45.0f;
				spellInfo->RangeEntry = sSpellRangeStore.LookupEntry(187); ///< 300 yrds
            ...
            case 137484: ///< Lightning Fissure (periodic)
                spellInfo->Effects[0].TargetA = TARGET_UNIT_CASTER;
                break;
			case 57841: ///< Killing Spree (damage)
				spellInfo->RangeEntry = sSpellRangeStore.LookupEntry(187); ///< 300 yards
				break;
           ...
           case 77219: ///< Mastery: Master Demonologist
            ...
            case 105174: ///< Hand of Gul'dan
                spellInfo->OverrideSpellList.push_back(123194); ///< Hand of Gul'dan (Glyphed)
                break;
            case 56248: ///< Glyph of Hand of Gul'dan
                spellInfo->Effects[EFFECT_0].Effect = SPELL_EFFECT_APPLY_AURA;
                spellInfo->Effects[EFFECT_0].ApplyAuraName = SPELL_AURA_DUMMY;
            ...
            case 89250: ///< Summon Cauldron
                spellInfo->Effects[EFFECT_0].TargetA = TARGET_DEST_DEST;
                break;
            case 160744: ///< Feast of Blood
                spellInfo->Effects[EFFECT_0].Effect = SPELL_EFFECT_TRIGGER_SPELL;
                spellInfo->Effects[EFFECT_0].TriggerSpell = 160745;
                break;
            case 175216: ///< Savage Feast
                spellInfo->Effects[EFFECT_0].Effect = SPELL_EFFECT_TRIGGER_SPELL;
                break;
            case 160745: ///< Feast of Blood
        ...
        switch (spellInfo->Id)
        {
            ...
            case 175585: ///< Living Blaze - AoE (Forgemistress Flamehand)
            case 156044: ///< Slag Bomb - AoE (Slag Bomb - Blackhand)
            case 156497: ///< Demolition - Small AoE (Blackrock Foundry - Blackhand)
            case 156479: ///< Massive Demolition - AoE (Blackrock Foundry - Blackhand)
            case 155992: ///< Shattering Smash (Blackhand)
            case 177438: ///< Exploding Iron Star (Blackrock Foundry - Blackhand)
            case 156646: ///< Battering Ram - AoE (Siegemaker - Blackhand)
            case 156531: ///< Mortar Blast - AoE (Siegemaker - Blackhand)
            case 177487: ///< Shattered Floor (Blackrock Foundry - Blackhand)
            case 156731: ///< Explosive Round (Iron Soldier - Blackhand)
            case 157015: ///< Slag Bomb (Attached Slag Bombs - Blackhand)
            case 156930: ///< Slag Eruption (Slag Hole - Blackhand)
            case 156948: ///< Huge Slag Eruption (Slag Crater - Blackhand)
            case 158054: ///< Massive Shattering Smash (Blackhand)
...
int64 SpellMgr::GetSpellVisualOverride(uint32 p_SpellID) const
{
    switch (p_SpellID)
    {
        ...
        case 62383: ///< Shatter (Ignis)
            return 12639;
        case 123194: ///< Hand of Gul'Dan (Glyphed)
            return 43885;
        default:
            break;
    }
...
void SpellMgr::LoadSpellAurasNotSave()
{
    ...
    m_SpellAurasNotSave.clear();

    QueryResult l_Result = WorldDatabase.Query("SELECT SpellID FROM spell_aura_not_saved");
    if (!l_Result)
    {
        sLog->outInfo(LogFilterType::LOG_FILTER_SERVER_LOADING, ">> Loaded 0 spell auras not save records. DB table `spell_aura_not_save` is empty.");
        return;
    }
    ...
    do
    {
        ...
        if (!l_SpellInfo)
        {
            sLog->outError(LogFilterType::LOG_FILTER_SQL, "spellId %u in `spell_aura_not_save` table is not found in dbc, skipped", l_SpellID);
            continue;
        }

        m_SpellAurasNotSave.insert(l_SpellID);
    }
    while (l_Result->NextRow());

    sLog->outInfo(LogFilterType::LOG_FILTER_SERVER_LOADING, ">> Loaded %u spell auras not save records in %u ms", m_SpellAurasNotSave.size(), GetMSTimeDiffToNow(l_OldMSTime));
}
