...
void InitOpcodes()
{
    ...
    #pragma region JamMove
        ...
        DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_DISABLE,                   STATUS_NEVER,         PROCESS_INPLACE,      &WorldSession::Handle_ServerSide,      PROCESS_LOCAL);
        DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_ENABLE,                    STATUS_NEVER,         PROCESS_INPLACE,      &WorldSession::Handle_ServerSide,      PROCESS_LOCAL);
        ...
        DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_START_SWIM,							STATUS_NEVER,		  PROCESS_INPLACE,      &WorldSession::Handle_ServerSide,      PROCESS_LOCAL);
        DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_STOP_SWIM,							STATUS_NEVER,         PROCESS_INPLACE,      &WorldSession::Handle_ServerSide,      PROCESS_LOCAL);
    ...
    DEFINE_OPCODE_HANDLER(CMSG_AUTOBANK_REAGENT,                                STATUS_LOGGEDIN,    PROCESS_THREADUNSAFE,   &WorldSession::HandleAutoBankReagentOpcode      , PROCESS_DISTANT_IF_NEED);
    DEFINE_OPCODE_HANDLER(CMSG_AUTOSTORE_BANK_REAGENT,                          STATUS_LOGGEDIN,    PROCESS_THREADUNSAFE,   &WorldSession::HandleAutoStoreBankReagentOpcode , PROCESS_DISTANT_IF_NEED);
    ...
    DEFINE_OPCODE_HANDLER(CMSG_UNLEARN_SPECIALIZATION,                          STATUS_LOGGEDIN,    PROCESS_THREADUNSAFE,   &WorldSession::HandleUnlearnSpecialization              , PROCESS_DISTANT_IF_NEED);
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_NEWS_UPDATE_STICKY,                        STATUS_LOGGEDIN,    PROCESS_THREADUNSAFE,   &WorldSession::HandleGuildNewsUpdateStickyOpcode               , PROCESS_LOCAL);
    ...
    DEFINE_OPCODE_HANDLER(CMSG_INSTANCE_LOCK_RESPONSE,					  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleInstanceLockResponse		 , PROCESS_LOCAL);
    ...
    //DEFINE_OPCODE_HANDLER(CMSG_TOGGLE_DIFFICULTY,				  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChangePlayerDifficulty    , PROCESS_LOCAL);
