...
#define SIGHT_RANGE_UNIT            100.0f
#define DEFAULT_VISIBILITY_DISTANCE 150.0f                   // default visible distance, 90 yards on continents
#define DEFAULT_VISIBILITY_INSTANCE 250.0f                  // default visible distance in instances, 170 yards
