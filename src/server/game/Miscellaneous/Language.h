...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_DEBUG_QUEST_LOGS_OFF                 = 3005,
    LANG_DEBUG_QUEST_LOGS_NO_QUESTGIVER       = 3006,
    LANG_DEBUG_QUEST_LOGS_NO_TEMPLATE         = 3007,
    LANG_DEBUG_QUEST_LOGS_NO_FLAG             = 3008,
    LANG_DEBUG_QUEST_LOGS_WRONG_STATUS        = 3009,
    LANG_DEBUG_QUEST_LOGS_DISABLED            = 3010,
    LANG_DEBUG_QUEST_LOGS_WRONG_CONDITION     = 3011,
    LANG_DEBUG_QUEST_LOGS_WRONG_TIME          = 3012,
    LANG_DEBUG_QUEST_LOGS_DOUBLE_EXCL         = 3013,
    LANG_DEBUG_QUEST_LOGS_ALT_QUEST           = 3014,
    LANG_DEBUG_QUEST_LOGS_CHAIN_NEXT          = 3015,
    LANG_DEBUG_QUEST_LOGS_CHAIN_PREV          = 3016,
    LANG_DEBUG_QUEST_LOGS_DAILY_DONE          = 3017,
    LANG_DEBUG_QUEST_LOGS_DF_DAILY            = 3018,
    LANG_DEBUG_QUEST_LOGS_WEEKLY_DONE         = 3019,
    LANG_DEBUG_QUEST_LOGS_SEASONNAL_DONE      = 3020,
    LANG_DEBUG_QUEST_LOGS_MONTHLY_DONE        = 3021,
    LANG_DEBUG_QUEST_LOGS_WRONG_FACTION       = 3022,
    LANG_DEBUG_QUEST_LOGS_WRONG_CLASS         = 3023,
    LANG_DEBUG_QUEST_LOGS_WRONG_RACE          = 3024,
    LANG_DEBUG_QUEST_LOGS_WRONG_MIN_REP       = 3025,
    LANG_DEBUG_QUEST_LOGS_WRONG_MAX_REP       = 3026,
    LANG_DEBUG_QUEST_LOGS_WRONG_OBJ_REP       = 3027,
    LANG_DEBUG_QUEST_LOGS_EXCL_GRP_ALT_COMP   = 3028,
    LANG_DEBUG_QUEST_LOGS_EXCL_GRP_ALT_ACTIVE = 3029,
    LANG_DEBUG_QUEST_LOGS_PREV_QUEST          = 3030,
    LANG_DEBUG_QUEST_LOGS_TOO_LOW_LVL         = 3031,
    LANG_DEBUG_QUEST_LOGS_TOO_HIGH_LVL        = 3032,
    LANG_DEBUG_QUEST_LOGS_WRONG_QUEST_LOG     = 3033,
    LANG_DEBUG_QUEST_LOGS_MISSING_SKILL       = 3034,
    ...
    LANG_INTERREALM_PLAYER_LOAD_FAILED      = 13107,
    LANG_INTERREALM_PLAYER_GROUP_FAILED     = 13108,
    LANG_INTERREALM_CANNOT_DO               = 13109,
    LANG_INTERREALM_FAILED_ALREADY_REGISTRED    = 13110,
