...
enum DiminishingGroup
{
	...
	DIMINISHING_CYCLONE,
	DIMINISHING_DISARM,
	DIMINISHING_DISORIENT,       // Several spells where name cant be generalized.
	DIMINISHING_FEAR,
	DIMINISHING_HORROR,
	DIMINISHING_LIMITONLY,
	DIMINISHING_KNOCKBACK,
	DIMINISHING_MESMERIZE,
	DIMINISHING_MESMERIZE_SHORT,
	DIMINISHING_STUN,
	DIMINISHING_STUN_SHORT,
	DIMINISHING_ROOT,
	DIMINISHING_ROOT_SHORT,
	DIMINISHING_SILENCE,
	DIMINISHING_SLEEP,
	DIMINISHING_TAUNT,
	DIMINISHING_MAX = DIMINISHING_TAUNT
};
