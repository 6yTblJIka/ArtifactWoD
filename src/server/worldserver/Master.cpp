...
int Master::Run()
{
    ...
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "    / \      _ __  | |_   (_)   / _|   __ _    ___  | |_  ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "   / _ \    | '__| | __|  | |  | |_   / _` |  / __| | __| ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "  / ___ \   | |    | |_   | |  |  _| | (_| | | (__  | |_  ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, " /_/   \_\_ |_|   _ \__|_ |_|_ |_|  _ \__,_|_ \___|_ \__| ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, " based on TrinityCore.\n");
