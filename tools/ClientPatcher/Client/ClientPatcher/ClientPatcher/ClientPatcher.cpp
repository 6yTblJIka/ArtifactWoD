...
const uint8_t config_data[]             = "Config.wtf";
const uint8_t build_date_data[]         = "[ArtifactCore]";
const uint8_t bnet_portal_data[]        = "";
const uint8_t bnet_logon_data[]         = ".localhost";
const uint8_t bnet_agent_data[]         = "noagt.exe";
const uint8_t bnet_versions_data[]      = "http://%s-cdn612.localhost/%s/versions";
const uint8_t bnet_cdns_data[]          = "http://%s-cdn612.localhost/%s/cdns";
